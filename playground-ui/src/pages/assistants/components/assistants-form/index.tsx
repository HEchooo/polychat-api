...
const modelList = [
    ...
    { label: 'pro-qwen2.5:7b-instruct', value: 'Pro/Qwen/Qwen2.5-7B-Instruct' },
    { label: 'qwen2.5:7b-instruct-int8', value: 'Qwen/Qwen2.5-7B-Instruct-GPTQ-Int8' },
    { label: 'qwen2.5:7b-instruct-int4', value: 'Qwen/Qwen2.5-7B-Instruct-GPTQ-Int4' },
